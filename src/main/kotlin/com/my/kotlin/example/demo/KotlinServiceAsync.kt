...
////@Service
//@Component
//open class KotlinServiceAsync @Autowired constructor(private val firstService: FirstService, private val secondService: SecondService, private val thirdService: ThirdService) { // передаем необходимые сервисы в качестве параметров главного конструктора (можно делать через DI)
